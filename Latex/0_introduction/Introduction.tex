...
\end{itemize}
The work presented in this thesis is part of this typology of research. Starting from an analysis of the theoretical contributions already developed for epidemiology, and in particular focusing on multilayer systems and mean-field models, the following questions are studied:
\begin{itemize}
	...
	\item What is the most efficient way to model population collective consciousness about the epidemic's development? This parameter can be useful to gain insight into society's reaction to the disease and the differences in behavior when the same conditions occur at different times, such as at the beginning of an outbreak versus several months later.
\end{itemize}
The objectives of this thesis are to address these questions and furthermore:
\begin{itemize}
