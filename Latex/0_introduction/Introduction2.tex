...
\begin{itemize}
	...
	%\item The quantity and quality of information available to the population can make a difference in how people deal with difficult situations?
...
\subsubsection{Homophily} The tendency to bond and associate preferentially with others that are similar. 
...
\begin{figure}[ht]
	\centering
	\subfloat[][\emph{}]
	{\includegraphics[width=0.47\linewidth]{0_introduction/images_introduction/sir_con_rt}} 
	\subfloat[][\emph{}]
	{\includegraphics[width=0.52\linewidth]{0_introduction/images_introduction/sir_multipli_beta}} \\
