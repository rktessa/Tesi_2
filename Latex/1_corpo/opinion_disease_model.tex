...
\begin{figure}[ht]
	\centering
	\subfloat[][\emph{ $S_C$ compartment varying $\psi$.}]
	{\includegraphics[width=0.48\linewidth]{1_corpo/figure/behav_epi_sim/E_0_model_1epi_behav_sim_psi}} \quad
	\subfloat[][\emph{ $I_{tot}$ compartment varying $\psi$.}]
	{\includegraphics[width=0.48\linewidth]{1_corpo/figure/behav_epi_sim/E_0_model_2epi_behav_sim_psi}} \\
