...
\begin{figure}[h]
	...
	{\includegraphics[width=.47\textwidth]{figure/behavioural_equilibrium/final_compliant_sensitivity}} \quad
	\subfloat[][\emph{Final Against compartment}]
	{\includegraphics[width=.47\textwidth]{figure/behavioural_equilibrium/final_against_sensitivity}} \\
	\subfloat[][\emph{Final Careless compartment}]
	{\includegraphics[width=.47\textwidth]{figure/behavioural_equilibrium/final_careless_sensitivity}}
...
\begin{figure}[h]
	\centering
	\subfloat[][\emph{Final Compliant compartment}]
	{\includegraphics[height=.45\textwidth]{figure/behavioural_equilibrium/final_compliant_r1}} \quad
	\subfloat[][\emph{Final Against compartment}]
	{\includegraphics[height=.45\textwidth]{figure/behavioural_equilibrium/final_against_r1}} \\
	\subfloat[][\emph{Final Careless compartment}]
	{\includegraphics[height=.45\textwidth]{figure/behavioural_equilibrium/final_careless_r1}}
