...
%% ODE solution
[taxisODE,xaxisODE,yaxisODE,zaxisODE,i] = Opinion_ODE(N,alpha,alpha_prime,time,dt,i);
...
function [taxis,xaxis,yaxis,zaxis,i] = Opinion_ODE(N,alpha,alpha_prime,time,dt,i)
