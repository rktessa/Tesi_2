...
% load("multilpiBehaviour.mat")
 % load("multilpiCareless.mat")
 % load("multilpiCompliant.mat")
%% 
% Against = Compliant;
Against = Careless;
%% Against plot
...
title(t,'Different simualtion of behaviour model')
    ...
    nexttile
    hold on
    l1 = 10; l2 = 15; l3 =15; l4 = 5; %high lam1, low lam2
    for ii = 1:30
        aga = reshape(Against(ii,l2,l3,l4,:),1,d2,[]);
        txt =  "\k1-"+ num2str(ii)+ "= "+ num2str(k1_vec(ii)); 
        plot(aga, 'LineWidth',1.5 ,'DisplayName',txt)
...
%  txt2 = {"k1= "+ num2str(k1_vec(l1)) +"k2= " + num2str(k2_vec(l2))} ;
    ...
    nexttile
    hold on
    l1 = 10; l2 = 15; l3 =9; l4 = 11; %equal lambdas, high k2
    for ii = 1:30
        aga = reshape(Against(ii,l2,l3,l4,:),1,d2,[]);
        txt =  "\k1-"+ num2str(ii)+ "= "+ num2str(k1_vec(ii)); 
        plot(aga, 'LineWidth',1.5 ,'DisplayName',txt)
    ...
    nexttile
    hold on
    l1 = 10; l2 = 15; l3 =8; l4 = 18;%low lam1, high lam2
    for ii = 1:30
        aga = reshape(Against(ii,l2,l3,l4,:),1,d2,[]);
        txt =  "\k1-"+ num2str(ii)+ "= "+ num2str(k1_vec(ii)); 
        plot(aga, 'LineWidth',1.5 ,'DisplayName',txt)
